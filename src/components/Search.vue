...
import { computed, inject, ref, watch, useTemplateRef, reactive, watchEffect} from 'vue';
...
export default {
  ...
  setup(props, ctx) {
    ...
    watchEffect(() => {
      searchField.width = bounding.width.value;
      searchField.bottom = bounding.bottom.value;
      searchField.left = bounding.left.value;
    })
